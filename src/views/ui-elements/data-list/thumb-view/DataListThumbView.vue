...
export default {
  ...
  computed: {
    ...
    products() {
      ...
      return [ { "id": 100, "category": "Fitness", "img": "https://pixinvent.com/demo/vuexy-vuejs-admin-dashboard-template/products/06.png", "name": "Fitbit - Activity Tracker", "order_status": "delivered", "popularity": 72, "price": 99.99 }]
    }
  },
  methods: {
    addNewData() {
