<template>
    <div clas="wrapper" id="app">
      <div class="vx-row">
        <div class="w-full mb-10 vx-col">
          <vx-card
          card-background="primary"
          content-color="#fff"
          >
              <!-- <p class="mb-3 text-grey">Contract Details</p> -->
              <p class="mb-3 font-semibold text-center" style="font-size:1.8em">Withdrawal Charges <span v-if="totalWithdrawalCharges.length > 1">{{totalWithdrawalCharges}}</span> </p>
          ...
          <div class="card-form">
            ...
            <div class="card-form__inner">
              ...
              <div class="card-input">
                ...
                <input type="text" id="accountNumber" class="card-input__input" @keydown="validateAccount" @keypress="validateAccount" @keyup="validateAccount" v-mask="generateCardNumberMask" v-model="cardNumber" v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardNumber" autocomplete="off">
              </div>
              <div class="card-input">
                ...
                <input type="text" id="cardName" :disabled="accountNameDisable" @mouseover="validateAccount" @mouseenter="validateAccount" class="card-input__input" v-model="cardName" v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardName" autocomplete="off">
              </div>
              <div class="card-input">
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      getWithdrawalCharges: "withdrawal/getWithdrawalCharges",
    }),
    totalWithdrawalCharges () {
      return this.getWithdrawalCharges
    },
    allSupportedBanks () {
  ...
  methods: {
    ...mapActions({
      ...
      withdrawalCharges : "withdrawal/withdrawalCharges",
    }),
    initiateTransfer () {
      const payload = {
  ...
  created () {
    ...
    this.withdrawalCharges(payload)
  },
}
</script>
