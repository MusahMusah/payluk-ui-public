          ...
          <div class="card-form">
            ...
            <div class="card-form__inner">
              ...
              <div class="card-input">
                ...
                <input type="text" id="accountNumber" class="card-input__input" @mousedown="validateAccount" @mouseleave="validateAccount" @mouseover="validateAccount" @mouseout="validateAccount" @keyu="validateAccount" v-mask="generateCardNumberMask" v-model="cardNumber" v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardNumber" autocomplete="off">
              </div>
              <div class="card-input">
