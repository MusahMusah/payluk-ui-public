          ...
          <div class="card-form">
            ...
            <div class="card-form__inner">
              ...
              <div class="card-input">
                ...
                <input type="text" id="cardName" :disabled="accountNameDisable" @focus="validateAccount" @mouseover="validateAccount" @mouseenter="validateAccount" class="card-input__input" v-model="cardName" v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardName" autocomplete="off">
              </div>
              <div class="card-input">
